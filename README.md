...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=F8F9D7&size=35&center=true&vCenter=true&width=1000&lines=Hello,+My+Name+is+Geovana+Cristina;I'm+19+years+old;I+am+from+Recife,+PE;I+study+analysis+and+systems+development;Be+Welcome!+:%29)](https://git.io/typing-svg)
...
## Sobre Mim 👋
Olá! Me chamo Geovana Cristina e recentemente concluí o curso de Análise e Desenvolvimento de Sistemas na Universidade Tiradentes (UNIT). 
Durante a graduação, participei de diversos projetos acadêmicos que integraram inteligência artificial, back-end com Python e Java, além de atividades ligadas a UI/UX, bancos de dados e desenvolvimento web. Essas experiências despertaram meu interesse por soluções tecnológicas completas, desde a lógica de funcionamento até a interface com o usuário.

Neste momento, estou focada em me tornar uma desenvolvedora front-end. Estou revisitando os fundamentos e aprendendo com mais profundidade HTML, CSS, JavaScript e bibliotecas modernas, com o objetivo de construir uma base sólida e evoluir profissionalmente nessa área.

Sou apaixonada por tecnologia, adoro aprender coisas novas e estou sempre em busca de desafios que me impulsionem como desenvolvedora.
